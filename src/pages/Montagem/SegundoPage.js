...
import Quantidade from '../../components/Somar';
...
export default class SegundoPage extends React.Component {
  ...
  proximaPage(){
    ...
    let somar=0;
    for(let i=0; i<preparo.length; i++){
                    ...
                    <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                      ...
                      {item.sel?
                        <View style={{flexDirection: 'row', flex: 1}}>
                          <Slider
                              style={{height: 30, margin:5, flex:1}}
                              minimumValue={0}
                              maximumValue={475}
                              value={item.volume}
                          ...
                          <View style={styles.boxValue}>
                              <Text style={{fontSize:20, color:'#0075e3'}}> {item.volume}ML</Text>
                          </View>
                        </View>
                        :
